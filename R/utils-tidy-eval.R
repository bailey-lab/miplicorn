...
#'
#' * [expr()] quotes a new expression _locally_. It
...
#' @name tidyeval
#' @keywords internal
#' @importFrom rlang enquo enquos expr .data := as_name as_label
#' @aliases enquo enquos expr .data := as_name as_label
#' @export enquo enquos expr .data := as_name as_label
NULL
