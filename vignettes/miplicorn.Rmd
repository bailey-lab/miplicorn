...
map <- chromosome_map(genome_Pf3D7, probes, "chromoMap", colours = colours)
...
```{r karyoploteR}
chromosome_map(genome_Pf3D7, probes, "karyoploteR", colours = colours)
```

### Average coverage
**N.B. the remaining figures have not yet been incorporated into miplicorn, **
**but as time goes on, more and more visualization methods will be added.**
