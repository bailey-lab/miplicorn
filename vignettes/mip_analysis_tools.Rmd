...
ref_file <- miplicorn::MIPr_example("reference_AA_table.csv")
alt_file <- miplicorn::MIPr_example("alternate_AA_table.csv")
cov_file <- miplicorn::MIPr_example("coverage_AA_table.csv")

analysis_tibble <- miplicorn::read(ref_file, alt_file, cov_file)
```
...
clinical_summary <- analysis_tibble %>% 
