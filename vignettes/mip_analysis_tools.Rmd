...
ref_file <- MIPr::MIPr_example("reference_AA_table.csv")
alt_file <- MIPr::MIPr_example("alternate_AA_table.csv")
cov_file <- MIPr::MIPr_example("coverage_AA_table.csv")

analysis_tibble <- MIPr::read(ref_file, alt_file, cov_file)
```
